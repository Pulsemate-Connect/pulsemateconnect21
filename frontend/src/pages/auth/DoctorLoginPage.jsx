...
const DoctorLoginPage = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      if (loginMethod === 'mobile') {
        await axios.post(`${API_URL}/api/auth/doctor/send-mobile-otp`, { mobile: `+91${mobile}` });
        toast.success('OTP sent to your mobile number');
      } else {
        await axios.post(`${API_URL}/api/auth/doctor/send-email-otp`, { email });
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      ...
      let response;
      if (loginMethod === 'mobile') {
        response = await axios.post(`${API_URL}/api/auth/doctor/verify-mobile-otp`, {
          mobile: `+91${mobile}`,
          otp,
        });
      } else {
        response = await axios.post(`${API_URL}/api/auth/doctor/verify-email-otp`, {
          email,
          otp,
        });
      }
