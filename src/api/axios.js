...
export const BASE_URL = isDev
  ? 'http://10.0.2.2:5000/api'  // ✅ ANDROID EMULATOR: 10.0.2.2 = host machine
  : 'https://api.pulsemateconnect.in/api';  // 🌐 PRODUCTION API

// For physical device on same WiFi, use: 'http://192.168.31.240:5000/api'
// For Android emulator, use: 'http://10.0.2.2:5000/api' (maps to host machine)

// Log the API URL on app start for debugging
console.log(`
╔═══════════════════════════════════════════════════════════════════════════════
║ 🔧 API CONFIGURATION
╠═══════════════════════════════════════════════════════════════════════════════
...
║ 🌐 Base URL: ${BASE_URL}
║ 🏠 Backend: ${isDev ? 'LOCAL DEVELOPMENT' : 'PRODUCTION'}
║ 🔌 Status: ${isDev ? 'Using emulator bridge at 10.0.2.2:5000' : 'Using production API'}
╚═══════════════════════════════════════════════════════════════════════════════
`);
