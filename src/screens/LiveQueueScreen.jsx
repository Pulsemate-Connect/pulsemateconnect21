...
export default function LiveQueueScreen({ route, navigation }) {
  ...
  const doctorPhoto   = appt?.doctor?.profilePhotoUrl || appt?.doctor?.profileImage;
          ...
          <View style={lq.card}>
            ...
            <View style={lq.doctorRow}>
              ...
              <View style={lq.doctorInfo}>
                <Text style={lq.doctorName}>{doctorName}</Text>
...
const lq = StyleSheet.create({
  ...
  doctorAvatarWrap:{ width: 52, height: 52, borderRadius: 16, backgroundColor: '#EFF6FF', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  doctorAvatarImage:{ width: 52, height: 52 },
