...
export default function HomeScreen({ navigation }) {
  ...
  const goDoctors    = () => navigation.navigate('DoctorsTab'); // Navigate to Doctors tab
  const goSpeciality = (spec) => {
    // Map speciality labels to filter keys
    const specialtyMap = {
    ...
    const mappedSpecialty = specialtyMap[spec.label] || spec.label.replace('\n', ' ');
    navigation.navigate('DoctorsTab', { screen: 'SearchMain', params: { initialSpecialty: mappedSpecialty } });
  };
