...
export default function OtpScreen({ route, navigation }) {
  ...
  }, []); // Only run on mount - refs and startCooldown are stable
  ...
  // ✅ BUG FIX #002: Auto-submit when 6 digits entered
  useEffect(() => {
    if (digits.join('').length === 6 && status === 'idle') handleVerify();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [digits, status]); // handleVerify is stable, excluded intentionally
